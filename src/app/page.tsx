    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-100 flex flex-col font-sans">
      <header className="w-full py-8 px-6 flex flex-col items-center justify-center bg-white/80 shadow-lg">
        <Image
          ...
          className="mb-2"
        />
        <h1 className="text-4xl sm:text-5xl font-extrabold text-blue-700 mb-2 tracking-tight animate-fade-in">
          Studena Matchmaking
        </h1>
        <p className="text-lg text-gray-700 max-w-xl text-center animate-fade-in2">
          Plateforme intelligente de mise en relation entre tuteurs et élèves,
          basée sur les matières, niveaux et disponibilités. Découvrez le
          matching parfait, instantanément.
        </p>
        <nav className="mt-6 flex gap-4">
          ...
          <Link
            href="/students"
            className="px-6 py-2 rounded-full bg-purple-600 text-white font-semibold shadow hover:bg-purple-700 transition"
          >
            Élèves
          </Link>
          <Link
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-12 sm:py-20 animate-fade-in3">
        ...
        <section className="max-w-2xl w-full bg-gradient-to-r from-blue-100 via-white to-purple-100 rounded-2xl shadow-lg p-8 border border-purple-100">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              href="/tutors"
              className="flex-1 px-6 py-4 rounded-xl bg-blue-600 text-white font-bold text-lg shadow-lg hover:bg-blue-700 transition text-center"
            >
              Ajouter un tuteur
            </Link>
            <Link
              href="/students"
              className="flex-1 px-6 py-4 rounded-xl bg-purple-600 text-white font-bold text-lg shadow-lg hover:bg-purple-700 transition text-center"
            >
              Ajouter un élève
            </Link>
            <Link
              href="/matchmaking"
              className="flex-1 px-6 py-4 rounded-xl bg-green-600 text-white font-bold text-lg shadow-lg hover:bg-green-700 transition text-center"
            >
      ...
      {/* Les animations sont à placer dans src/app/globals.css pour éviter l'erreur Next.js Server Component. */}
    </div>
  );
}
